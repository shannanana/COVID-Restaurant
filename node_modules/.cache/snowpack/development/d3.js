import { h as hue$1, n as nogamma, i as interpolate$1, a as now, T as Timer, S as SCHEDULED, b as Transition, d as dispatch, s as select, c as interrupt, p as pointer, e as dragDisable, y as yesdrag, t as timer, f as ascending$3, g as numbers$1, j as number$1, k as initRange, l as number$2, m as linearish, o as copy$1, q as ticks$1, r as nice$1, u as transformer$3, v as identity$7, w as continuous, x as bisectRight$1, z as newInterval$1, A as durationMinute$1, B as durationHour$1, C as calendar, D as utcFormat$1, E as millisecond$1, F as second$1, G as utcDay$1, H as utcSunday$1, I as utcYear$1, J as initInterpolator, K as interpolateRound, L as rgbBasis } from './common/time-25b026f0.js';
export { O as axisBottom, P as axisLeft, N as axisRight, M as axisTop, ac as create, ad as creator, d as dispatch, Q as drag, e as dragDisable, y as dragEnable, W as easeCubic, X as easeCubicIn, W as easeCubicInOut, Y as easeCubicOut, R as easeQuad, U as easeQuadIn, R as easeQuadInOut, V as easeQuadOut, i as interpolate, Z as interpolateArray, _ as interpolateBasis, $ as interpolateBasisClosed, a0 as interpolateDate, a1 as interpolateNumber, a2 as interpolateNumberArray, a3 as interpolateObject, a7 as interpolateRgb, L as interpolateRgbBasis, a8 as interpolateRgbBasisClosed, K as interpolateRound, a4 as interpolateString, a5 as interpolateTransformCss, a6 as interpolateTransformSvg, c as interrupt, ae as local, af as matcher, ag as namespace, ah as namespaces, a as now, p as pointer, ai as pointers, a9 as scaleLinear, aa as scaleTime, s as select, aj as selectAll, ak as selection, al as selector, am as selectorAll, an as style, ab as tickFormat, aq as timeout, t as timer, ap as timerFlush, ar as transition, ao as window } from './common/time-25b026f0.js';
import { R as Rgb$1, r as rgbConvert$1, d as define$1, e as extend$1, C as Color$1, b as brighter$1, a as darker$1, h as hsl$3, f as format$1, c as rgb$1 } from './common/precisionRound-fc3c72f8.js';
import { D as Delaunator } from './common/index-85f664df.js';
...
function ribbon(headRadius) {
  ...
  function ribbon() {
    ...
    if (ap > epsilon) {
      if (abs$1(sa1 - sa0) > ap * 2 + epsilon) sa1 > sa0 ? (sa0 += ap, sa1 -= ap) : (sa0 -= ap, sa1 += ap);
      else sa0 = sa1 = (sa0 + sa1) / 2;
      if (abs$1(ta1 - ta0) > ap * 2 + epsilon) ta1 > ta0 ? (ta0 += ap, ta1 -= ap) : (ta0 -= ap, ta1 += ap);
  ...
  if (headRadius) ribbon.headRadius = function(_) {
    return arguments.length ? (headRadius = typeof _ === "function" ? _ : constant$2(+_), ribbon) : headRadius;
  };

  ribbon.radius = function(_) {
    return arguments.length ? (sourceRadius = targetRadius = typeof _ === "function" ? _ : constant$2(+_), ribbon) : sourceRadius;
  };

  ribbon.sourceRadius = function(_) {
    return arguments.length ? (sourceRadius = typeof _ === "function" ? _ : constant$2(+_), ribbon) : sourceRadius;
  };

  ribbon.targetRadius = function(_) {
    return arguments.length ? (targetRadius = typeof _ === "function" ? _ : constant$2(+_), ribbon) : targetRadius;
  };
  ...
  ribbon.padAngle = function(_) {
    return arguments.length ? (padAngle = typeof _ === "function" ? _ : constant$2(+_), ribbon) : padAngle;
  };
...
function gray(l, opacity) {
  return new Lab$1(l, 0, 0, opacity == null ? 1 : opacity);
}
...
define(Lab$1, lab$2, extend(Color, {
  brighter: function(k) {
...
function lch(l, c, h, opacity) {
  return arguments.length === 1 ? hclConvert$1(l) : new Hcl$1(h, c, l, opacity == null ? 1 : opacity);
}
...
define(Hcl$1, hcl$3, extend(Color, {
  brighter: function(k) {
...
define(Cubehelix$1, cubehelix$3, extend(Color, {
  brighter: function(k) {
    k = k == null ? brighter : Math.pow(brighter, k);
...
function clipAntimeridianLine(stream) {
  ...
  return {
    ...
    point: function(lambda1, phi1) {
      ...
      if (abs$2(delta - pi$3) < epsilon$3) { // line crosses a pole
...
function clipCircle(radius) {
  ...
  function intersect(a, b, two) {
    ...
    var delta = lambda1 - lambda0,
        polar = abs$2(delta - pi$3) < epsilon$3,
...
function graticule() {
  ...
  function lines() {
    return range(ceil(X0 / DX) * DX, X1, DX).map(X)
        ...
        .concat(range(ceil(x0 / dx) * dx, x1, dx).filter(function(x) { return abs$2(x % DX) > epsilon$3; }).map(x))
        .concat(range(ceil(y0 / dy) * dy, y1, dy).filter(function(y) { return abs$2(y % DY) > epsilon$3; }).map(y));
  }
...
// Based on https://github.com/mourner/quickselect
// ISC license, Copyright 2018 Vladimir Agafonkin.
function quickselect$1(array, k, left = 0, right = array.length - 1, compare = ascending$3) {
  while (right > left) {
    if (right - left > 600) {
      const n = right - left + 1;
      const m = k - left + 1;
...
function utcTime() {
  return initRange.apply(calendar(utcYear$1, utcMonth, utcSunday$1, utcDay$1, utcHour, utcMinute, second$1, millisecond$1, utcFormat$1).domain([Date.UTC(2000, 0, 1), Date.UTC(2000, 0, 2)]), arguments);
}
...
function sequentialQuantile() {
  ...
  function scale(x) {
    if (!isNaN(x = +x)) return interpolator((bisectRight$1(domain, x, 1) - 1) / (domain.length - 1));
  }
...
function cornerTangents(x0, y0, x1, y1, r1, rc, cw) {
  var x01 = x0 - x1,
      ...
      r = r1 - rc,
      D = x11 * y10 - x10 * y11,
      d = (dy < 0 ? -1 : 1) * sqrt$2(max$5(0, r * r * d2 - D * D)),
      cx0 = (D * dy - dx * d) / d2,
      cy0 = (-D * dx - dy * d) / d2,
      cx1 = (D * dy + dx * d) / d2,
      cy1 = (-D * dx + dy * d) / d2,
...
function line(x, y) {
  ...
  x = typeof x === "function" ? x : (x === undefined) ? x$3 : constant$7(x);
  y = typeof y === "function" ? y : (y === undefined) ? y$3 : constant$7(y);
...
function area$3(x0, y0, y1) {
  ...
  x0 = typeof x0 === "function" ? x0 : (x0 === undefined) ? x$3 : constant$7(+x0);
  y0 = typeof y0 === "function" ? y0 : (y0 === undefined) ? constant$7(0) : constant$7(+y0);
  y1 = typeof y1 === "function" ? y1 : (y1 === undefined) ? y$3 : constant$7(+y1);
...
function symbol(type, size) {
  var context = null;
  type = typeof type === "function" ? type : constant$7(type || circle$2);
...
function stack() {
  ...
  function stack(data) {
    ...
    for (i = 0, oz = array$3(order(sz)); i < n; ++i) {
      sz[oz[i]].index = i;
    }
  ...
  stack.order = function(_) {
    return arguments.length ? (order = _ == null ? none$1 : typeof _ === "function" ? _ : constant$7(Array.from(_)), stack) : order;
  };
...
var utcMinutes = utcMinute$1.range;
...
var utcMonths = utcMonth$1.range;
...
export { Adder, Delaunay, FormatSpecifier, Voronoi, active, arc, area$3 as area, areaRadial, ascending, autoType, bin, bisectRight as bisect, bisectCenter, bisectLeft, bisectRight, bisector, blob, brush, brushSelection, brushX, brushY, buffer, chord, chordDirected, chordTranspose, cluster, color, density as contourDensity, contours, count, cross, csv$1 as csv, csvFormat, csvFormatBody, csvFormatRow, csvFormatRows, csvFormatValue, csvParse, csvParseRows, cubehelix$3 as cubehelix, cumsum, basis as curveBasis, basisClosed as curveBasisClosed, basisOpen as curveBasisOpen, bundle as curveBundle, cardinal as curveCardinal, cardinalClosed as curveCardinalClosed, cardinalOpen as curveCardinalOpen, catmullRom as curveCatmullRom, catmullRomClosed as curveCatmullRomClosed, catmullRomOpen as curveCatmullRomOpen, curveLinear, linearClosed as curveLinearClosed, monotoneX as curveMonotoneX, monotoneY as curveMonotoneY, natural as curveNatural, step as curveStep, stepAfter as curveStepAfter, stepBefore as curveStepBefore, descending, deviation, difference, disjoint, dsv, dsvFormat, backInOut as easeBack, backIn as easeBackIn, backInOut as easeBackInOut, backOut as easeBackOut, bounceOut as easeBounce, bounceIn as easeBounceIn, bounceInOut as easeBounceInOut, bounceOut as easeBounceOut, circleInOut as easeCircle, circleIn as easeCircleIn, circleInOut as easeCircleInOut, circleOut as easeCircleOut, elasticOut as easeElastic, elasticIn as easeElasticIn, elasticInOut as easeElasticInOut, elasticOut as easeElasticOut, expInOut as easeExp, expIn as easeExpIn, expInOut as easeExpInOut, expOut as easeExpOut, linear as easeLinear, polyInOut as easePoly, polyIn as easePolyIn, polyInOut as easePolyInOut, polyOut as easePolyOut, sinInOut as easeSin, sinIn as easeSinIn, sinInOut as easeSinInOut, sinOut as easeSinOut, every, extent, filter, center as forceCenter, collide as forceCollide, link as forceLink, manyBody as forceManyBody, radial as forceRadial, simulation as forceSimulation, x$2 as forceX, y$2 as forceY, format, defaultLocale as formatDefaultLocale, formatLocale, formatPrefix, formatSpecifier, fsum, albers as geoAlbers, albersUsa as geoAlbersUsa, area$1 as geoArea, azimuthalEqualArea as geoAzimuthalEqualArea, azimuthalEqualAreaRaw as geoAzimuthalEqualAreaRaw, azimuthalEquidistant as geoAzimuthalEquidistant, azimuthalEquidistantRaw as geoAzimuthalEquidistantRaw, bounds as geoBounds, centroid as geoCentroid, circle as geoCircle, clipAntimeridian as geoClipAntimeridian, clipCircle as geoClipCircle, extent$2 as geoClipExtent, clipRectangle as geoClipRectangle, conicConformal as geoConicConformal, conicConformalRaw as geoConicConformalRaw, conicEqualArea as geoConicEqualArea, conicEqualAreaRaw as geoConicEqualAreaRaw, conicEquidistant as geoConicEquidistant, conicEquidistantRaw as geoConicEquidistantRaw, contains$1 as geoContains, distance as geoDistance, equalEarth as geoEqualEarth, equalEarthRaw as geoEqualEarthRaw, equirectangular as geoEquirectangular, equirectangularRaw as geoEquirectangularRaw, gnomonic as geoGnomonic, gnomonicRaw as geoGnomonicRaw, graticule as geoGraticule, graticule10 as geoGraticule10, identity$3 as geoIdentity, interpolate as geoInterpolate, length$2 as geoLength, mercator as geoMercator, mercatorRaw as geoMercatorRaw, naturalEarth1 as geoNaturalEarth1, naturalEarth1Raw as geoNaturalEarth1Raw, orthographic as geoOrthographic, orthographicRaw as geoOrthographicRaw, index$2 as geoPath, projection as geoProjection, projectionMutator as geoProjectionMutator, rotation as geoRotation, stereographic as geoStereographic, stereographicRaw as geoStereographicRaw, geoStream, transform as geoTransform, transverseMercator as geoTransverseMercator, transverseMercatorRaw as geoTransverseMercatorRaw, gray, greatest, greatestIndex, group, groups, hcl$3 as hcl, hierarchy, bin as histogram, hsl$2 as hsl, html, image, index, indexes, Blues as interpolateBlues, BrBG as interpolateBrBG, BuGn as interpolateBuGn, BuPu as interpolateBuPu, cividis as interpolateCividis, cool as interpolateCool, cubehelix$2 as interpolateCubehelix, cubehelix$4 as interpolateCubehelixDefault, cubehelixLong as interpolateCubehelixLong, discrete as interpolateDiscrete, GnBu as interpolateGnBu, Greens as interpolateGreens, Greys as interpolateGreys, hcl$2 as interpolateHcl, hclLong as interpolateHclLong, hsl$1 as interpolateHsl, hslLong as interpolateHslLong, hue as interpolateHue, inferno as interpolateInferno, lab$1 as interpolateLab, magma as interpolateMagma, OrRd as interpolateOrRd, Oranges as interpolateOranges, PRGn as interpolatePRGn, PiYG as interpolatePiYG, plasma as interpolatePlasma, PuBu as interpolatePuBu, PuBuGn as interpolatePuBuGn, PuOr as interpolatePuOr, PuRd as interpolatePuRd, Purples as interpolatePurples, rainbow as interpolateRainbow, RdBu as interpolateRdBu, RdGy as interpolateRdGy, RdPu as interpolateRdPu, RdYlBu as interpolateRdYlBu, RdYlGn as interpolateRdYlGn, Reds as interpolateReds, sinebow as interpolateSinebow, Spectral as interpolateSpectral, turbo as interpolateTurbo, viridis as interpolateViridis, warm as interpolateWarm, YlGn as interpolateYlGn, YlGnBu as interpolateYlGnBu, YlOrBr as interpolateYlOrBr, YlOrRd as interpolateYlOrRd, interpolateZoom, intersection, interval, formatIso as isoFormat, parseIso as isoParse, json, lab$2 as lab, lch, least, leastIndex, line, lineRadial$1 as lineRadial, linkHorizontal, linkRadial, linkVertical, map, max, maxIndex, mean, median, merge, min, minIndex, nice, index$3 as pack, enclose as packEnclose, siblings as packSiblings, pairs, partition, path, permute, pie, piecewise, pointRadial, area$2 as polygonArea, centroid$1 as polygonCentroid, contains$2 as polygonContains, hull as polygonHull, length$3 as polygonLength, precisionFixed, precisionPrefix, precisionRound, quadtree, quantile, quantileSorted, quantize, quickselect, areaRadial as radialArea, lineRadial$1 as radialLine, bates as randomBates, bernoulli as randomBernoulli, beta as randomBeta, binomial as randomBinomial, cauchy as randomCauchy, exponential as randomExponential, gamma as randomGamma, geometric as randomGeometric, int as randomInt, irwinHall as randomIrwinHall, lcg$1 as randomLcg, logNormal as randomLogNormal, logistic as randomLogistic, normal as randomNormal, pareto as randomPareto, poisson as randomPoisson, uniform as randomUniform, weibull as randomWeibull, range, reduce, reverse, rgb, ribbon$1 as ribbon, ribbonArrow, rollup, rollups, band as scaleBand, diverging as scaleDiverging, divergingLog as scaleDivergingLog, divergingPow as scaleDivergingPow, divergingSqrt as scaleDivergingSqrt, divergingSymlog as scaleDivergingSymlog, identity$4 as scaleIdentity, implicit as scaleImplicit, log$1 as scaleLog, ordinal as scaleOrdinal, point as scalePoint, pow$2 as scalePow, quantile$2 as scaleQuantile, quantize$1 as scaleQuantize, radial$1 as scaleRadial, sequential as scaleSequential, sequentialLog as scaleSequentialLog, sequentialPow as scaleSequentialPow, sequentialQuantile as scaleSequentialQuantile, sequentialSqrt as scaleSequentialSqrt, sequentialSymlog as scaleSequentialSymlog, sqrt$1 as scaleSqrt, symlog as scaleSymlog, threshold as scaleThreshold, utcTime as scaleUtc, scan, Accent as schemeAccent, scheme$l as schemeBlues, scheme as schemeBrBG, scheme$9 as schemeBuGn, scheme$a as schemeBuPu, category10 as schemeCategory10, Dark2 as schemeDark2, scheme$b as schemeGnBu, scheme$m as schemeGreens, scheme$n as schemeGreys, scheme$c as schemeOrRd, scheme$q as schemeOranges, scheme$1 as schemePRGn, Paired as schemePaired, Pastel1 as schemePastel1, Pastel2 as schemePastel2, scheme$2 as schemePiYG, scheme$e as schemePuBu, scheme$d as schemePuBuGn, scheme$3 as schemePuOr, scheme$f as schemePuRd, scheme$o as schemePurples, scheme$4 as schemeRdBu, scheme$5 as schemeRdGy, scheme$g as schemeRdPu, scheme$6 as schemeRdYlBu, scheme$7 as schemeRdYlGn, scheme$p as schemeReds, Set1 as schemeSet1, Set2 as schemeSet2, Set3 as schemeSet3, scheme$8 as schemeSpectral, Tableau10 as schemeTableau10, scheme$i as schemeYlGn, scheme$h as schemeYlGnBu, scheme$j as schemeYlOrBr, scheme$k as schemeYlOrRd, shuffle, shuffler, some, sort, stack, diverging$1 as stackOffsetDiverging, expand as stackOffsetExpand, none as stackOffsetNone, silhouette as stackOffsetSilhouette, wiggle as stackOffsetWiggle, appearance as stackOrderAppearance, ascending$2 as stackOrderAscending, descending$2 as stackOrderDescending, insideOut as stackOrderInsideOut, none$1 as stackOrderNone, reverse$1 as stackOrderReverse, stratify, subset, sum, superset, svg, symbol, circle$2 as symbolCircle, cross$2 as symbolCross, diamond as symbolDiamond, square$1 as symbolSquare, star as symbolStar, triangle as symbolTriangle, wye as symbolWye, symbols, text, freedmanDiaconis as thresholdFreedmanDiaconis, scott as thresholdScott, sturges as thresholdSturges, tickIncrement, tickStep, ticks, day as timeDay, days as timeDays, timeFormat, defaultLocale$1 as timeFormatDefaultLocale, formatLocale$1 as timeFormatLocale, friday as timeFriday, fridays as timeFridays, hour as timeHour, hours as timeHours, newInterval as timeInterval, millisecond as timeMillisecond, milliseconds as timeMilliseconds, minute as timeMinute, minutes as timeMinutes, monday as timeMonday, mondays as timeMondays, month as timeMonth, months as timeMonths, timeParse, saturday as timeSaturday, saturdays as timeSaturdays, second as timeSecond, seconds as timeSeconds, sunday as timeSunday, sundays as timeSundays, thursday as timeThursday, thursdays as timeThursdays, tuesday as timeTuesday, tuesdays as timeTuesdays, wednesday as timeWednesday, wednesdays as timeWednesdays, sunday as timeWeek, sundays as timeWeeks, year as timeYear, years as timeYears, transpose, tree, index$4 as treemap, binary as treemapBinary, treemapDice, resquarify as treemapResquarify, treemapSlice, sliceDice as treemapSliceDice, squarify as treemapSquarify, tsv$1 as tsv, tsvFormat, tsvFormatBody, tsvFormatRow, tsvFormatRows, tsvFormatValue, tsvParse, tsvParseRows, union, utcDay, utcDays, utcFormat, utcFriday, utcFridays, utcHour$1 as utcHour, utcHours, millisecond as utcMillisecond, milliseconds as utcMilliseconds, utcMinute$1 as utcMinute, utcMinutes, utcMonday, utcMondays, utcMonth$1 as utcMonth, utcMonths, utcParse, utcSaturday, utcSaturdays, second as utcSecond, seconds as utcSeconds, utcSunday, utcSundays, utcThursday, utcThursdays, utcTuesday, utcTuesdays, utcWednesday, utcWednesdays, utcSunday as utcWeek, utcSundays as utcWeeks, utcYear, utcYears, variance, version, xml, zip, zoom, identity$6 as zoomIdentity, transform$1 as zoomTransform };
