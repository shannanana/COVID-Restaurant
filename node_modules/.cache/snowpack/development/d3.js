import { R as Rgb, r as rgbConvert, d as define, e as extend, C as Color, b as brighter, a as darker, c as rgb, f as color, h as hsl$2, g as geoStream, i as adder, n as noop$3, t as tau$4, j as atan2$1, k as cos$2, s as sin$2, q as quarterPi, l as radians, m as asin$1, o as sqrt$2, p as epsilon$4, u as abs$1, v as degrees$1, w as epsilon2$2, x as pi$4, y as acos$1, z as halfPi$3, A as sign$1, B as atan, D as geoDistance, E as ceil, F as log$1, G as tan, H as exp, I as pow$1, J as formatSpecifier, K as precisionFixed, L as precisionRound, M as precisionPrefix, N as formatPrefix, O as format } from './common/interpolate-6dfbc9c3.js';
export { S as FormatSpecifier, f as color, O as format, P as formatDefaultLocale, Q as formatLocale, N as formatPrefix, J as formatSpecifier, D as geoDistance, T as geoInterpolate, U as geoLength, g as geoStream, h as hsl, K as precisionFixed, M as precisionPrefix, L as precisionRound, c as rgb } from './common/interpolate-6dfbc9c3.js';
...
function longitude(point) {
  if (abs$1(point[0]) <= pi$4)
    return point[0];
  else
    return sign$1(point[0]) * ((abs$1(point[0]) + pi$4) % tau$4 - pi$4);
}
...
function polygonContains(polygon, point) {
  ...
  for (var i = 0, n = polygon.length; i < n; ++i) {
    ...
    for (var j = 0; j < m; ++j, lambda0 = lambda1, sinPhi0 = sinPhi1, cosPhi0 = cosPhi1, point0 = point1) {
      ...
      sum$1.add(atan2$1(k * sign * sin$2(absDelta), cosPhi0 * cosPhi1 + k * cos$2(absDelta)));
  ...
  for (var i = 0, n = coordinates.length; i < n; i++) {
    ...
    if (i > 0) {
      ...
      if (
        ...
        ao <= ab &&
        bo <= ab &&
        (ao + bo - ab) * (1 - Math.pow((ao - bo) / ab, 2)) < epsilon2$2 * ab
      )
        return true;
    }
    ao = bo;
...
function graticule() {
  ...
  function lines() {
    return sequence(ceil(X0 / DX) * DX, X1, DX).map(X)
        ...
        .concat(sequence(ceil(x0 / dx) * dx, x1, dx).filter(function(x) { return abs$1(x % DX) > epsilon$4; }).map(x))
        .concat(sequence(ceil(y0 / dy) * dy, y1, dy).filter(function(y) { return abs$1(y % DY) > epsilon$4; }).map(y));
  }
...
equalEarthRaw.invert = function(x, y) {
  ...
  for (var i = 0, delta, fy, fpy; i < iterations; ++i) {
    ...
    if (abs$1(delta) < epsilon2$2) break;
  }
  return [
...
function identity$4() {
  ...
  projection.angle = function(_) {
    return arguments.length ? (alpha = _ % 360 * radians, sa = sin$2(alpha), ca = cos$2(alpha), reset()) : alpha * degrees$1;
  };
  projection.reflectX = function(_) {
...
function transformer$1() {
  ...
  scale.domain = function(_) {
    return arguments.length ? (domain = map$2.call(_, number$2), clamp === identity$5 || (clamp = clamper(domain)), rescale()) : domain.slice();
  };
...
function transform$1(node) {
  while (!node.__zoom) if (!(node = node.parentNode)) return identity$8;
  return node.__zoom;
}
